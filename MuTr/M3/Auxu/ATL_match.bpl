...
procedure IS2IS_matchAll() returns ();
 ...
 (read($srcHeap, is1, HSM$AbstractState.compositeState)==null || !read($srcHeap,read($srcHeap, is1, HSM$AbstractState.compositeState),alloc)) && false  ==>
...
{  (read(hp, is1, HSM$AbstractState.compositeState)==null || !read(hp,read(hp, is1, HSM$AbstractState.compositeState),alloc)) && false  }
