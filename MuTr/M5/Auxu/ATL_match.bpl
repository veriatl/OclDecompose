...
procedure T2TA_matchAll() returns ();
 ...
 !(dtype(read($srcHeap, t1, HSM$Transition.source)) == HSM$CompositeState) && !(dtype(read($srcHeap, t1, HSM$Transition.target)) == HSM$CompositeState) && false  ==>
...
{  !(dtype(read(hp, t1, HSM$Transition.source)) == HSM$CompositeState) && !(dtype(read(hp, t1, HSM$Transition.target)) == HSM$CompositeState) && false  }
